// common-component.js
class CommonComponent10 extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    const image7 = this.getAttribute("image7") || "default.jpg";
    const image8 = this.getAttribute("image8") || "default.jpg";
    const image9 = this.getAttribute("image9") || "default.jpg";
    const image10 = this.getAttribute("image10") || "default.jpg";
    const image11 = this.getAttribute("image11") || "default.jpg";
    const image12 = this.getAttribute("image12") || "default.jpg";
    const image13 = this.getAttribute("image13") || "default.jpg";
    ...
    const data7 = this.getAttribute("data7") || "Default Title";
    const data8 = this.getAttribute("data8") || "Default Title";
    const data9 = this.getAttribute("data9") || "Default Title";
    const data10 = this.getAttribute("data10") || "Default Title";
    const data11 = this.getAttribute("data11") || "Default Title";
    const data12 = this.getAttribute("data12") || "Default Title";
    const data13 = this.getAttribute("data13") || "Default Title";
    ...
    const sub_data6 = this.getAttribute("sub_data6") || "Default Title";
    const sub_data7 = this.getAttribute("sub_data7") || "Default Title";
    const sub_data8 = this.getAttribute("sub_data8") || "Default Title";
    const sub_data9 = this.getAttribute("sub_data9") || "Default Title";
    const sub_data10 = this.getAttribute("sub_data10") || "Default Title";
    const sub_data11 = this.getAttribute("sub_data11") || "Default Title";
    const sub_data12 = this.getAttribute("sub_data12") || "Default Title";
    const sub_data13 = this.getAttribute("sub_data13") || "Default Title";

    const isShow = this.getAttribute("isShow") || "11";
    ...
    this.shadowRoot.innerHTML = `
      ...
      <section style="background-color: #f7f6fd">
      <div class="container-fluid section-padding">
        <h3>${title} </h3>
        <p class="text_lg text-center more-mindmap-content">
        ${text_base}
        </p>
        <div class="benefit-section">
          ...
          <div class="benefit-box">
            ...
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #75BB0B1A">
              <img src=${image6} alt="icon6" />
            </div>
            <h5 class="text_xl">${data6}</h5>
            <p class="text_sm">
             ${sub_data6}
            </p>
          </div>
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #f998111a">
              <img src=${image7} alt="icon7" />
            </div>
            <h5 class="text_xl">${data7}</h5>
            <p class="text_sm">
             ${sub_data7}
            </p>
          </div>
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #8035E81A">
              <img src=${image8} alt="icon8" />
            </div>
            <h5 class="text_xl">${data8}</h5>
            <p class="text_sm">
             ${sub_data8}
            </p>
          </div>
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #20D8F81A">
              <img src=${image9} alt="icon9" />
            </div>
            <h5 class="text_xl">${data9}</h5>
            <p class="text_sm">
             ${sub_data9}
            </p>
          </div>
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #EF1C791A">
              <img src=${image10} alt="icon10" />
            </div>
            <h5 class="text_xl">${data10}</h5>
            <p class="text_sm">
             ${sub_data10}
            </p>
          </div>
            <div class="benefit-box">
            <div class="benefit-icon" style="background: #75BB0B1A">
              <img src=${image11} alt="icon11" />
            </div>
            <h5 class="text_xl">${data11}</h5>
            <p class="text_sm">
             ${sub_data11}
            </p>
          </div>
          ...
          <div class="benefit-box">
           ...
           ${
             isShow === "13"
               ? ` <div class="benefit-box">
            <div class="benefit-icon" style="background: #8035e81a">
              <img src=${image13} alt="icon5" />
            </div>
            <h5 class="text_xl">${data13}</h5>
            <p class="text_sm">
             ${sub_data13}
            </p>
          </div>`
...
customElements.define("feature-teams-benefit", CommonComponent10);
