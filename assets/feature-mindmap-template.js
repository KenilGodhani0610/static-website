// common-component.js
class CommonComponent6 extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    const subtitle = this.getAttribute("subtitle") || "Default Title";
    ...
    this.shadowRoot.innerHTML = `
      ...
      margin: 0 auto;
       ...
       /* section 6 */
        .category-section {
        background: #F9FAFC;
        backdrop-filter: blur(130.98451232910156px)
      ...
      .category-section .sub-title {
       ...
       .mindmap-swiper-slide .swiper-box-title2 {
        ...
        .active-prev-next-slide .swiper-silde-box2{
          width: 230px;
          height: 180px;
          max-height: 180px;
          min-height: 180px;
        }
        .swiper-silde-box2 img {
          width: 60% !important;
          object-fit: contain;
        }
        .swiper-silde-box-last .swiper-silde-box3{
          width: 138px;
          height: 110px;
          max-height: 110px;
          min-height: 110px;
        }
        .swiper-silde-box3 img {
      ...
      <div class="container-fluid">
        ...
        <p class="text-center more-mindmap-content sub-title text_base">
         ${subtitle}
        </p>
        <div class="mindmap-template dekstop-mind-template">
          ...
          <div class="mindmap-swiper-slide active-prev-next-slide">
            ...
            <div class="swiper-box-title2">${data2}</div>
          </div>
          ...
          <div class="mindmap-swiper-slide active-prev-next-slide">
            ...
            <div class="swiper-box-title2">${data4}</div>
          </div>
          <div class="mindmap-swiper-slide swiper-silde-box-last">
            <div class="swiper-silde-box swiper-silde-box3">
              <img
...
customElements.define("feature-mindmap-template", CommonComponent6);
