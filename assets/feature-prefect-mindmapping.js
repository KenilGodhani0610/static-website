class CommonComponent5 extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    ...
    const data = this.getAttribute("data") || "Default Title";
    const subdata = this.getAttribute("subdata") || "Default Title";
    const image =
    ...
    this.shadowRoot.innerHTML = `
     ...
     <section class="container-fluid">
      <div class="mind-mapping-section" style="background-color: #F9FAFC">
        <h3>${title}</h3>
        <p class="text_base text-center more-mindmap-content">
         ${subtitle}
        </p>
        <div class="more-mindmap-section">
          <div>
            <img src=${image} alt="mind-map" />
          </div>
          <div class="more-mindmap-section-right">
            <h4>${data}</h4>
            <p class="text_base" style="color: #18181B">
              ${subdata}
            </p>
          </div>
        </div>
