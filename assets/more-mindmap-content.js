...
class CommonComponent extends HTMLElement {
  ...
  render() {
    ...
    const title1 = this.getAttribute("title1") || "Default Title";
    const title2 = this.getAttribute("title2") || "Default Title";
    const title3 = this.getAttribute("title3") || "Default Title";
    const title4 = this.getAttribute("title4") || "Default Title";
    const title5 = this.getAttribute("title5") || "Default Title";
    const title1_data = this.getAttribute("title1_data") || "Default Title";
    const title2_data = this.getAttribute("title2_data") || "Default Title";
    const title3_data = this.getAttribute("title3_data") || "Default Title";
    const title4_data = this.getAttribute("title4_data") || "Default Title";
    const title5_data = this.getAttribute("title5_data") || "Default Title";
    const isShow = this.getAttribute("isShow") || "5";
    const iscontent = this.getAttribute("iscontent" || "true");
    // const iscontent = this.getAttribute("iscontent") === "true";
...
;
    ...
    <section class="container-fluid">
      ...
      <div class="use-case-section">
        ...
        <div>
          <div class="usecase-content ${isShow === "4" ? "mt-30" : ""}">
            <div class="usecase-no">01</div>
            <div class="usecase-heading-data" style="padding-left: 10px">
              <p class="text_xl usecase-heading">${title1}</p>
              <p class="text_base">
                 ${
                   iscontent
                     ? ""
          ...
          <div class="usecase-content">
            <div class="usecase-no">02</div>
            <div class="usecase-heading-data">
              <p class="text_xl usecase-heading">${title2}</p>
              <p class="text_base">
               ${
                 iscontent
                   ? ""
          ...
          <div class="usecase-content">
            <div class="usecase-no">03</div>
            <div class="usecase-heading-data">
              <p class="text_xl usecase-heading">${title3}</p>
              <p class="text_base">
            ${
              iscontent
                ? ""
          ...
          <div class="usecase-content">
            <div class="usecase-no">04</div>
            <div class="usecase-heading-data">
              <p class="text_xl usecase-heading">${title4}</p>
              <p class="text_base">
                 ${
                   iscontent
                     ? ""
          ...
          ${
            isShow === "5"
              ? `
               <div class="usecase-content">
                <div class="usecase-no">05</div>
                <div class="usecase-heading-data">
                  <p class="text_xl usecase-heading">${title5}</p>
                  <p class="text_base">
                   ${
                     iscontent
                       ? ""
...
customElements.define("more-mindmap-content", CommonComponent);
